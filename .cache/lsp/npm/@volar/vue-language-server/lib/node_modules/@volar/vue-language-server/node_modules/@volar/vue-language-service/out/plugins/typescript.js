...
function default_1(options) {
    ...
    return {
        ...
        format(document, range, options_2) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                if (isTsDocument(document)) {
                    const enable = yield ((_a = (0, vue_language_service_types_1.useConfigurationHost)()) === null || _a === void 0 ? void 0 : _a.getConfiguration(getConfigTitle(document) + '.format.enable', document.uri));
                    if (enable === false) {
                        return;
                    }
