...
function createProjects(runtimeEnv, languageConfigs, ts, tsLocalized, options, documents, connection, lsConfigs, getInferredCompilerOptions, capabilities) {
    ...
    function onDidChangeContent(uri) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const workspace of workspaces.values()) {
                ...
                for (const project of projects) {
                    (yield project).onDocumentUpdated();
                }
            }
