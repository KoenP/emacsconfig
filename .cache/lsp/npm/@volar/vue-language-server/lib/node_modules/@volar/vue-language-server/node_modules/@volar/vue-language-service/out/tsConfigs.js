...
function getFormatOptions(configurationHost, uri, options) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s;
    return __awaiter(this, void 0, void 0, function* () {
        let config = yield (configurationHost === null || configurationHost === void 0 ? void 0 : configurationHost.getConfiguration(isTypeScriptDocument(uri) ? 'typescript.format' : 'javascript.format', uri));
...
function getPreferences(configurationHost, uri) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3;
    return __awaiter(this, void 0, void 0, function* () {
        let config = yield (configurationHost === null || configurationHost === void 0 ? void 0 : configurationHost.getConfiguration(isTypeScriptDocument(uri) ? 'typescript' : 'javascript', uri));
        let preferencesConfig = yield (configurationHost === null || configurationHost === void 0 ? void 0 : configurationHost.getConfiguration(isTypeScriptDocument(uri) ? 'typescript.preferences' : 'javascript.preferences', uri));
        config = config !== null && config !== void 0 ? config : {};
        ...
        const preferences = {
            ...
            includeInlayParameterNameHintsWhenArgumentMatchesName: !((_l = (_k = (_j = config.inlayHints) === null || _j === void 0 ? void 0 : _j.parameterNames) === null || _k === void 0 ? void 0 : _k.suppressWhenArgumentMatchesName) !== null && _l !== void 0 ? _l : true),
            includeInlayFunctionParameterTypeHints: (_p = (_o = (_m = config.inlayHints) === null || _m === void 0 ? void 0 : _m.parameterTypes) === null || _o === void 0 ? void 0 : _o.enabled) !== null && _p !== void 0 ? _p : false,
            includeInlayVariableTypeHints: (_s = (_r = (_q = config.inlayHints) === null || _q === void 0 ? void 0 : _q.variableTypes) === null || _r === void 0 ? void 0 : _r.enabled) !== null && _s !== void 0 ? _s : false,
            includeInlayPropertyDeclarationTypeHints: (_v = (_u = (_t = config.inlayHints) === null || _t === void 0 ? void 0 : _t.propertyDeclarationTypes) === null || _u === void 0 ? void 0 : _u.enabled) !== null && _v !== void 0 ? _v : false,
            includeInlayFunctionLikeReturnTypeHints: (_y = (_x = (_w = config.inlayHints) === null || _w === void 0 ? void 0 : _w.functionLikeReturnTypes) === null || _x === void 0 ? void 0 : _x.enabled) !== null && _y !== void 0 ? _y : false,
            includeInlayEnumMemberValueHints: (_1 = (_0 = (_z = config.inlayHints) === null || _z === void 0 ? void 0 : _z.enumMemberValues) === null || _0 === void 0 ? void 0 : _0.enabled) !== null && _1 !== void 0 ? _1 : false,
            // custom
            includeCompletionsForModuleExports: (_3 = (_2 = config.suggest) === null || _2 === void 0 ? void 0 : _2.autoImports) !== null && _3 !== void 0 ? _3 : true,
        };
        return preferences;
    });
}
...
function isTypeScriptDocument(uri) {
