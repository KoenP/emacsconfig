...
function createLanguageService(vueLsHost, fileSystemProvider, schemaRequestService, configurationHost, customPlugins, getNameCases, createLanguageServiceContext = () => vue.createLanguageContext(vueLsHost)) {
    ...
    const vueDocuments = (0, vueDocuments_1.parseVueDocuments)(core, tsLs);
