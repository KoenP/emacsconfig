...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "lsp-nim" '("lsp-nim-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "lsp-terraform" '("lsp-t" "construct-tf-package")))
